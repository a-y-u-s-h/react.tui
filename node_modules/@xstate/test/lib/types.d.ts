...
export interface TestPlan<TTestContext, TContext> {
     ...
     */
    testContext: TTestContext) => Promise<void> | void;
}
/**
...
export declare type StatePredicate<TContext> = (state: State<TContext, any>) => boolean;
/**
 * Executes an effect using the `testContext` and `event`
 * that triggers the represented `event`.
 */
export declare type EventExecutor<T> = (
/**
 ...
 */
event: EventObject) => Promise<any> | void;
