...
var TestModel = /** @class */ (function () {
    ...
    TestModel.prototype.getShortestPathPlans = function (options) {
        var shortestPaths = getShortestPaths(this.machine, __assign(__assign({}, options), { events: getEventSamples(this.options.events) }));
    ...
    TestModel.prototype.getSimplePathPlans = function (options) {
        var simplePaths = getSimplePaths(this.machine, __assign(__assign({}, options), { events: getEventSamples(this.options.events) }));
                                        ...
                                        '\nPath:\n' +
                                            testPathResult.segments
                                                ...
                                                var eventResult = "\tEvent: " + (hasFailed_1
                                                    ...
                                                    : s.event.error
                                                        ? ((hasFailed_1 = true), slimChalk('red', eventString))
 ...
 */
export function createModel(machine, options) {
