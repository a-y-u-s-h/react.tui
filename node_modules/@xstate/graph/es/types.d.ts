...
export declare type ExtractEvent<TEvent extends EventObject, TType extends TEvent['type']> = TEvent extends {
    type: TType;
} ? TEvent : never;
export interface ValueAdjMapOptions<TContext, TEvent extends EventObject> {
    events?: {
        [K in TEvent['type']]?: Array<ExtractEvent<TEvent, K>> | ((state: State<TContext, TEvent>) => Array<ExtractEvent<TEvent, K>>);
    };
